    ...
    render(html`
      <div class="flex-initial p-2 h-full border-r-2 border-r-gray-200">
        ...
        <a
          ...
          href="${libraryRoute}">
          <div class="w-6"><img class="w-full" src="/public/icons/library-icon-dark.svg" alt=""></div>
        </a>
        <a
          class="rounded-2xl bg-gray-100 aspect-square p-2 m-2 flex justify-center items-center hover:bg-gray-200 transition"
          href="${analysisRoute}">
          <div class="w-6"><img class="w-full" src="/public/icons/analysis-icon-dark.svg" alt=""></div>
        </a>
      </div>
    `, this)
